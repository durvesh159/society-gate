  ...
  return (
    <div className="flex h-screen text-gray-900">
      ...
      <div className="flex-1 flex flex-col overflow-auto">
        ...
        <header className="bg-gradient-to-br from-purple-300 via-purple-300 to-purple-300 backdrop-blur-xl shadow-lg border-b border-purple-200/40 px-6 py-4 flex justify-between items-center">
