// // src/pages/guard/StaffAttendance.jsx
  ...
  return (
    <DashboardLayout role="guard" onLogout={logout}>
      <div className="p-4 md:p-8 min-h-screen bg-gray-100">
        ...
        {/* PAGE TITLE */}
        <h1 className="text-2xl md:text-3xl font-bold text-purple-900 mb-6 text-center md:text-left">
          Staff Attendance
        </h1>
        ...
        {/* ============================= */}
        <div className="bg-white p-4 md:p-6 rounded-xl shadow mb-8 border border-purple-200">
        ...
        {/* ============================= */}
        <div className="bg-white p-4 md:p-6 rounded-xl shadow border border-purple-200">
          <h2 className="text-lg md:text-xl font-semibold mb-3">
            Attendance History
          </h2>
            ...
            <table className="w-full table-auto text-sm md:text-base">
              <thead className="bg-purple-200 text-purple-900">
                <tr>
                  ...
                  <th className="p-2 whitespace-nowrap">Entry</th>
                  <th className="p-2 whitespace-nowrap">Exit</th>
                </tr>
              </thead>
              ...
              <tbody>
                ...
                {history.length === 0 && (
                  <tr>
                    <td colSpan={4} className="p-4 text-gray-500 text-sm md:text-base">
                      No history found.
                    </td>
                  </tr>
                )}
