...
//         <h1 className="text-3xl font-semibold mb-8 text-blue-900">Visitor History</h1>
...
//             <h2 className="text-lg font-semibold">All Visitor Records</h2>
//           </div>
...
//                     <th className="p-3 min-w-[150px]">Purpose</th>
//                     <th className="p-3 min-w-[150px]">Status</th>
//                     <th className="p-3 min-w-[120px]">Passcode</th>
//                   </tr>
//                 </thead>
...
//                       <td className="p-3">{v.passcode || "--"}</td>
//                     </tr>
//                   ))}
//                 </tbody>
//               </table>
